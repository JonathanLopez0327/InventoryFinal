<?php
  ...
  switch ($opcion) {
    case 1:
      ...
      VALUES ('$code_product', '$name_product', '$unit_porduct', '$stock', '$date_initial', '$category', '$unitary_price $ RD')";
    ...
    case 4:
      ...
      $consulta = "SELECT * FROM type_inventory_a WHERE CATEGORY = 'Mobiliarios'";

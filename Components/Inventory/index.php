        ...
        <v-container fluid>
          ...
          <template>
            <v-card-title>
              ...
              <v-btn class="elevation-10 ma-2" fab dark small color="#245699" @click="Imprimir">
          ...
          <template>
            <v-card height="650" cols="12" sm="6" md="4" class="mt-8">
              ...
              <section class="table">
                <v-data-table id="datatable" dense height="400" class="data-table" :headers="headers" :items="productos" :search="search" :items-per-page="10">
                  <!-- Modal for add -->
                  ...
                  <!-- Options Eition -->
                  <template v-slot:item.accion="{ item }" class="lol">
                    <v-icon dark class="lol" color="#245699" @click="check(item)">mdi-eye</v-icon>

                    <v-icon dark class="lol" color="#245699" @click="editar(item)">mdi-pencil</v-icon>

                    <v-icon dark class="lol" color="error" @click="borrar(item)">mdi-delete</v-icon>

                    <v-icon dark class="lol" color="#6dbec6" @click="obtener(item)">mdi-package-variant-closed</v-icon>

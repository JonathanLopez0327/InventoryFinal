  ...
  new Vue({
    ...
    data: () => ({
      ...
      itemsNav: [
        ...
        },
        {
          ...
          children: [
            ...
            { icon: "mdi-package-variant", text: "Inventario General" },
          ],
        },
        {
          icon: "mdi-file-chart",
      ...
      headers: [
        ...
        { text: "", value: "accion", sortable: false },
    ...
    methods: {
      ...
      Imprimir() {
          $('.table').printThis({
            ...
            loadCSS: "http://localhost/Inventory/PrintStyle.css",      // path to additional css file - use an array [] for multiple
